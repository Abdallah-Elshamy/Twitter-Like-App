         ...
         <div className = "flex">
             <input  type="Email" className="h-16 max-w-3xl pr-3 py-2 pl-2 rounded-lg border-2 border-gray-200 outline-none focus:border-blue-300 mt-6 ml-12" 
                    placeholder="   Email"/>  
                     ...
                     <div>
                        <input type=" password" className="h-16 max-w-3xl pr-3 py-2 pl-2 rounded-lg border-2 border-gray-200 outline-none focus:border-blue-300 mt-6 ml-12" 
                        placeholder="   Password"/>  
                        <p className = "ml-16 mt-2 text-sm text-blue-400"><a href="#" target="_blank"> Forget password?  </a> </p>  
                     </div>
                   ...
                   <TweetButton name = "login" className = "w-28 ml-12 h-8"/> 
                    ...
                    <p className=" ml-12 mt-12 text-4xl mt-4 font-bold ">Join twitter today. </p>   
