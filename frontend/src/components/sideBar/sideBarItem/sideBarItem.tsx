    ...
    return (
      ...
      <div className="flex">
        <div className="flex-initial ...">
          <nav className="overflow-hidden	 md:pb-0 md:overflow-y-auto mt-2">

            <div>
              <button className="block lg:mx-2 py-3 mt-3 font-semibold md:mt-0 not-italic hover:text-gray-900 rounded-full bg-white text-black
