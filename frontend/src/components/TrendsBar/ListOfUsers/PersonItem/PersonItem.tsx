...
const TrendItem: React.FC<PersonEntity> = ({ id, name, username, followed = false, imageURI, numberOfFollowers }) => {
  ...
  return (
    <Link to={'/' + username}>
      ...
      <div className=" person-item flex  justify-between items-center p-3">
        ...
        <div className="person-item-image w-11 h-11 grid  rounded-full  flex flex-col mr-2 ">
          {profilePicture}
        </div>
