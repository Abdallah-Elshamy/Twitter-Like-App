  ...
  return (
    ...
    <div>
      <ToolBox className="fixed bottom-0 rounded-full w-8 mt-4 mb-2
          ...
          <div className="flex justify-between items-start lg:p-3 justify-center">
        ...
        <ul className="px-4 mt-24 bg-white" >
          <a href="/profile" className="mt-1 w-28 block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 
          hover:text-gray-900   rounded-full">My Account</a>

          {
            (age > 18) &&
            <button className="mt-1 w-28  block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 
